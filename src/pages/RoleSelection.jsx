    ...
    <div className="relative min-h-screen flex flex-col">
      ...
      <div className="bg-green-700 text-white px-6 h-20 flex items-center justify-between shadow-2xl relative z-10">
        <div className="absolute top-2 left-3">
          ...
          <p className="text-sm mt-1 drop-shadow-md">Connecting Health Empowering Life</p>
        </div>
      </div>
      ...
      <section className="px-6 py-10 bg-gray-100 z-20 bg-gradient-to-r from-green-50 to-blue-50">
        <h2 className="text-3xl font-bold text-center mb-10 text-gray-800">Select Your Role</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 text-center 
                    transform transition-all duration-500 ease-in-out
                    hover:scale-105 hover:shadow-4xl hover:-translate-y-3">
            <h3 className="text-xl font-semibold mb-3 text-green-700">Pet Owner</h3>
      ...
      <section className="px-6 py-10 bg-gray-100 z-10 bg-gradient-to-r from-green-50 to-blue-50">
        <h2 className="text-3xl font-bold text-center mb-10 text-black-800">Key Features by Role</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Doctor Features */}
